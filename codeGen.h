enum code_ops {START,HALT, PNEW, LD_INT_VALUE, STORE, WRITE_INT, LD_VAR, ADD, SUB, MUL, DIV, LD_INT, EQN, NEQ, LTN, GTN, GTE, LTE, JMP_FALSE, GOTO, LABEL};

char *op_name[] = {"start", "halt", "pnew", "ld_int_value", "store", "write_int", "ld_var", "add","sub", "mul", "div", "ld_int", "eqn", "nqe", "ltn","gtn", "gte", "lte", "jmp_false", "goto", "label"};
